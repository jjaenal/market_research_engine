...
| FND-006 | Project Status      | `docs/00-foundation/FND-006_Project_Status.md`      | 1.3.29   | Active   |
| FND-007 | Roadmap             | `docs/00-foundation/FND-007_Roadmap.md`             | 1.1.0   | Active   |
| FND-008 | TODO                   | `docs/00-foundation/FND-008_TODO.md`                   | 1.3.28   | Active   |
...
| ARC-008 | Architecture Review Based on Evidence | `docs/02-architecture/ARC-008_Architecture_Review_Based_on_Evidence.md` | 1.0.6 | Result |
...
| ID      | Document                        | Path                               | Version | Status  |
| ------- | ------------------------------- | ---------------------------------- | ------- | ------- |
| EXP-001 | RSI Trendline Breakout Baseline | `docs/07-experiments/EXP-001_RSI_Trendline_Breakout_Baseline.md` | 1.0.5 | Result |
