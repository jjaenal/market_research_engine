...
| FND-006 | Project Status      | `docs/00-foundation/FND-006_Project_Status.md`      | 1.3.6   | Active   |
...
| ID      | Document                | Path                                                  | Version | Status  |
| ------- | ----------------------- | ----------------------------------------------------- | ------- | ------- |
| RSH-001 | Research Methodology    | `docs/05-research/RSH-001_Research_Methodology.md`    | 1.0.0   | Draft |
| RSH-002 | Experiment Specification | `docs/05-research/RSH-002_Experiment_Specification.md` | 1.0.0   | Draft |
