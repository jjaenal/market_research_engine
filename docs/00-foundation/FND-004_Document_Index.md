...
| FND-006 | Project Status      | `docs/00-foundation/FND-006_Project_Status.md`      | 1.3.19   | Active   |
| FND-007 | Roadmap             | `docs/00-foundation/FND-007_Roadmap.md`             | 1.1.0   | Active   |
| FND-008 | TODO                   | `docs/00-foundation/FND-008_TODO.md`                   | 1.3.18   | Active   |
...
| ID      | Document                        | Path                               | Version | Status  |
| ------- | ------------------------------- | ---------------------------------- | ------- | ------- |
| EXP-001 | RSI Trendline Breakout Baseline | `docs/07-experiments/EXP-001_RSI_Trendline_Breakout_Baseline.md` | 1.0.1 | Result |
