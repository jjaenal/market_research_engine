...
- Next work is **ARC-ACT-012 Define Signal Deduplication Semantics** (M7 iteration, first of ARC-ACT-010..014 from ARC-008). TODO-025 (OOS), TODO-026 (Robustness), TODO-027 (Research Conclusion — **PARTIALLY SUPPORTED**), and TODO-028 (Architecture Review Based on Evidence, ARC-008 — **CORE HOLDS, PERIPHERY DRIFTS**) are DONE; M6 validation and the M7 review are complete.
